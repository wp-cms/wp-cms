...
if( ! class_exists('acs_field__group') ) :

class acs_field__group extends acs_field {
	...
	*/
	...
	function render_field_block( $field ) {
		...
		// html
		echo '<div class="acs-fields -' . $label_placement . ' -border">';
	...
	<thead>
		...
		<?php foreach( $field['sub_fields'] as $sub_field ): 
			...
			<th <?php acs_esc_attr_e( $atts ); ?>>
				<?php acs_render_field_label( $sub_field ); ?>
				<?php acs_render_field_instructions( $sub_field ); ?>
			</th>
		<?php endforeach; ?>
		</tr>
	</thead>
...
<?php
	...
	*/
	...
	function render_field_settings( $field ) {
		...
		?><tr class="acs-field acs-field-setting-sub_fields" data-setting="group" data-name="sub_fields">
			<td class="acs-label">
...
// initialize
acs_register_field_type( 'acs_field__group' );
