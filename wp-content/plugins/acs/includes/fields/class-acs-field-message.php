...
if( ! class_exists('acs_field_message') ) :

class acs_field_message extends acs_field {
	...
	*/
	...
	function render_field_settings( $field ) {
		...
		// HTML
		acs_render_field_setting( $field, array(
			'label'			=> __('Escape HTML','acs'),
			'instructions'	=> __('Allow HTML markup to display as visible text instead of rendering','acs'),
			'name'			=> 'esc_html',
			'type'			=> 'true_false',
			'ui'			=> 1,
		));
...
// initialize
acs_register_field_type( 'acs_field_message' );
