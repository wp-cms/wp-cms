...
if( ! class_exists('acs_field_color_picker') ) :

class acs_field_color_picker extends acs_field {
	...
	*/
	...
	function initialize() {
		...
		$this->label = __("Color Picker",'acs');
	...
	*/
	...
	function render_field( $field ) {
		...
		// vars
		$text_input = acs_get_sub_array( $field, array('id', 'class', 'name', 'value') );
		$hidden_input = acs_get_sub_array( $field, array('name', 'value') );
		
		
		// html
		?>
		<div class="acs-color-picker">
...
// initialize
acs_register_field_type( 'acs_field_color_picker' );
