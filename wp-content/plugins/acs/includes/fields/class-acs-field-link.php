...
if( ! class_exists('acs_field_link') ) :

class acs_field_link extends acs_field {
...
<div <?php acs_esc_attr_e($div); ?>>
	...
	<div class="acs-hidden">
		...
		<?php foreach( $link as $k => $v ): ?>
			<?php acs_hidden_input(array( 'class' => "input-$k", 'name' => $field['name'] . "[$k]", 'value' => $v )); ?>
		<?php endforeach; ?>
	</div>
	
	<a href="#" class="button" data-name="add" target=""><?php _e('Select Link', 'acs'); ?></a>
	...
	<div class="link-wrap">
		...
		<i class="acs-icon -link-ext acs-js-tooltip" title="<?php _e('Opens in a new window/tab', 'acs'); ?>"></i><?php
		?><a class="acs-icon -pencil -clear acs-js-tooltip" data-name="edit" href="#" title="<?php _e('Edit', 'acs'); ?>"></a><?php
		?><a class="acs-icon -cancel -clear acs-js-tooltip" data-name="remove" href="#" title="<?php _e('Remove', 'acs'); ?>"></a>
	</div>
...
// initialize
acs_register_field_type( 'acs_field_link' );
