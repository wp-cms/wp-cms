...
/*
*  ACS 3rd Party Compatibility Class
*
*  All the logic for 3rd party functionality
*
*  @class 		acs_third_party
*  @package		ACS
*  @subpackage	Core
*/

if( ! class_exists('acs_third_party') ) :
...
class acs_third_party {
	...
	*/
	...
	function __construct() {
		...
		if( function_exists('espresso_version') ) {
			add_filter('acs/get_post_types', array($this, 'ee_get_post_types'), 10, 2);
		}
	...
	*  tabify_posttypes
	*
	*  This function removes ACS post types from the tabify edit screen (post type selection sidebar)
	*
	*  @type	function
	*  @date	9/10/12
	*  @since	3.5.1
	...
	*/
	...
	function tabify_posttypes( $posttypes ) {
		...
		// unset
		unset( $posttypes['acs-field-group'] );
		unset( $posttypes['acs-field'] );
	...
	*/
	...
	function doing_dark_mode() {
		wp_enqueue_style('acs-dark', acs_get_url('assets/css/acs-dark.css'), array(), ACS_VERSION );
	}
