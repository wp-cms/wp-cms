...
function acs_get_locale() {
	 ...
	 */
	return apply_filters( 'acs/get_locale', $locale );
}
 ...
 * @return	void
 */
function acs_load_textdomain( $domain = 'acs' ) {
	 ...
	 */
	$locale = apply_filters( 'plugin_locale', acs_get_locale(), $domain );
	...
	return load_textdomain( $domain, acs_get_path( 'lang/' . $mofile ) );
}

 /**
 * _acs_apply_language_cache_key
 *
 ...
 * @return	string
 */
function _acs_apply_language_cache_key( $key ) {
	
	// Get current language.
	$current_language = acs_get_setting('current_language');
	if( $current_language ) {
...
// Hook into filter.
add_filter( 'acs/get_cache_key', '_acs_apply_language_cache_key' );
