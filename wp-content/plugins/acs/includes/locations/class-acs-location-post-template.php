...
if( ! class_exists('ACS_Location_Post_Template') ) :

class ACS_Location_Post_Template extends ACS_Location {
	...
	public function initialize() {
		...
		$this->label = __( "Post Template", 'acs' );
		$this->category = 'post';
...
// initialize
acs_register_location_type( 'ACS_Location_Post_Template' );
