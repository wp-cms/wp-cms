...
if( ! class_exists('ACS_Location') ) :

abstract class ACS_Location extends ACS_Legacy_Location {
	 ...
	 * 
	 * Accepts an object type discoverable by `acs_get_object_type()`.
	 *
	 * @since 5.9.0
	 * @var string
	 */
