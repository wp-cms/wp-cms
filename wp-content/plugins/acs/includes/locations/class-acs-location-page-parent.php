...
if( ! class_exists('ACS_Location_Page_Parent') ) :

class ACS_Location_Page_Parent extends ACS_Location {
	...
	public function get_values( $rule ) {
		return acs_get_location_type( 'page' )->get_values( $rule );
	}
}

// Register.
acs_register_location_type( 'ACS_Location_Page_Parent' );
