...
if( ! class_exists('ACS_Location_Nav_Menu') ) :

class ACS_Location_Nav_Menu extends ACS_Location {
...
// Register.
acs_register_location_type( 'ACS_Location_Nav_Menu' );
