...
if( ! class_exists('ACS_Location_User_Form') ) :

class ACS_Location_User_Form extends ACS_Location {
	...
	public function get_values( $rule ) {
		return array(
			'all' 		=> __('All', 'acs'),
			'add' 		=> __('Add', 'acs'),
			'edit' 		=> __('Add / Edit', 'acs'),
			'register' 	=> __('Register', 'acs')
		);		
	}
}

// Register.
acs_register_location_type( 'ACS_Location_User_Form' );
