...
if( ! class_exists('ACS_Location_Attachment') ) :

class ACS_Location_Attachment extends ACS_Location {
	...
	public function get_values( $rule ) {
		...
		foreach( $mime_types as $regex => $mime_type ) {
			...
			$choices[ $type ][ $type ] = sprintf( __('All %s formats', 'acs'), $type);
...
// Register.
acs_register_location_type( 'ACS_Location_Attachment' );
