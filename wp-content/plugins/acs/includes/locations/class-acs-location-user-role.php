...
if( ! class_exists('ACS_Location_User_Role') ) :

class ACS_Location_User_Role extends ACS_Location {
...
// initialize
acs_register_location_type( 'ACS_Location_User_Role' );
