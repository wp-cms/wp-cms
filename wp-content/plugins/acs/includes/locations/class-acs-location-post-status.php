...
if( ! class_exists('ACS_Location_Post_Status') ) :

class ACS_Location_Post_Status extends ACS_Location {
...
// initialize
acs_register_location_type( 'ACS_Location_Post_Status' );
