...
if( ! class_exists('ACS_Location_Post_Format') ) :

class ACS_Location_Post_Format extends ACS_Location {
...
// initialize
acs_register_location_type( 'ACS_Location_Post_Format' );
