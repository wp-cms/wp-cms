 ...
 * @return	array
 */
function acs_get_users( $args = array() ) {
 ...
 * @return	array
 */
function acs_get_user_result( $user ) {
 ...
 * @return	array
 */
function acs_get_user_role_labels( $roles = array() ) {
 ...
 * @return	bool
 */
function acs_allow_unfiltered_html() {
	 ...
	 */
	return apply_filters( 'acs/allow_unfiltered_html', $allow_unfiltered_html );
}