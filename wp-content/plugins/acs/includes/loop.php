...
class acs_loop {
	...
	*/
	...
	function add_loop( $loop = array() ) {
		...
		// ensure array
		$loop['value'] = acs_get_array( $loop['value'] );
...
function acs_add_loop( $loop = array() ) {
	
	return acs()->loop->add_loop( $loop );
...
function acs_update_loop( $i = 'active', $key = null, $value = null ) {
	
	return acs()->loop->update_loop( $i, $key, $value );
...
function acs_get_loop( $i = 'active', $key = null ) {
	
	return acs()->loop->get_loop( $i, $key );
...
function acs_remove_loop( $i = 'active' ) {
	
	return acs()->loop->remove_loop( $i );
