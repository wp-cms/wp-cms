...
?>
    <div id="signup-content" class="widecolumn">
        <div class="mu_register wp-signup-container" role="main">
			 ...
			 */
			function show_blog_form( string $blogname = '', string $blog_title = '', WP_Error|string $errors = '' ) {
			 ...
			 * @param WP_Error|string $errors A WP_Error object containing existing errors. Defaults to empty string.
			 */
			function show_user_form( string $user_name = '', string $user_email = '', WP_Error|string $errors = '' ) {
				if ( ! is_wp_error( $errors ) ) {
					$errors = new WP_Error();
				}
			 ...
			 * @param WP_Error|string $errors     A WP_Error object containing existing errors. Defaults to empty string.
			 */
			function signup_another_blog( string $blogname = '', string $blog_title = '', WP_Error|string $errors = '' ) {
