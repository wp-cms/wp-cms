<?php
/**
 * ClassicPress environment setup class.
 *
...
class WP {
	 ...
	 * @var array
	 */
	public $public_query_vars = array( 'm', 'p', 'posts', 'w', 'cat', 'withcomments', 'withoutcomments', 's', 'search', 'exact', 'sentence', 'calendar', 'page', 'paged', 'more', 'pb', 'author', 'order', 'orderby', 'year', 'monthnum', 'day', 'hour', 'minute', 'second', 'name', 'category_name', 'tag', 'feed', 'author_name', 'pagename', 'page_id', 'error', 'attachment', 'attachment_id', 'subpost', 'subpost_id', 'preview', 'robots', 'taxonomy', 'term', 'cpage', 'post_type', 'embed' );
	...
	/**
	 * Query variables for setting up the ClassicPress Query Loop.
	 *
	 * @since WP-2.0.0
	 * @var array
	 */
	...
	/**
	 * Parse request to find correct ClassicPress query.
	 *
	...
	/**
	 * Sets up all of the variables required by the ClassicPress environment.
	 *
	...
	public function main($query_args = '') {
		...
		/**
		 * Fires once the ClassicPress environment has been set up.
		 *
		 * @since WP-2.1.0
		 *
		 * @param WP $this Current ClassicPress environment instance (passed by reference).
