 ...
 * Core Metadata API
 *
 * Functions for retrieving and manipulating metadata of various ClassicPress object types. Metadata
...
function update_meta_cache($meta_type, $object_ids) {
	...
	$id_list = join( ',', $ids );
	$id_column = 'user' == $meta_type ? 'umeta_id' : 'meta_id';
	$meta_list = $wpdb->get_results( "SELECT $column, meta_key, meta_value FROM $table WHERE $column IN ($id_list) ORDER BY $id_column ASC", 'associative_array' );
 ...
 *
 * @since WP-3.3.0
 * @since WP-4.6.0 {@link https://core.trac.wordpress.org/ticket/35658 Modified
