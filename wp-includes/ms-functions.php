...
--The Team @ SITE_NAME' );
	...
	if ( empty( $current_network->site_name ) )
		$current_network->site_name = 'ClassicPress';
 ...
 *
 * ClassicPress ships with a set of allowed upload filetypes,
 ...
 *
 * ClassicPress MS stores a blog's post count as an option so as
